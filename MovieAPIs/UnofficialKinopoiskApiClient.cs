...
namespace MovieAPIs
{
    public class UnofficialKinopoiskApiClient : MovieApiClientBase
    {
        ...
        public async Task<Film> GetFilmByIdAsync(int id, CancellationToken ct)
        {
            string path = $"{constants.FilmsUrlV22}/{id}";
            return await GetResponseDataAsync<Film>(path, ct);
        }
        
        public IAsyncEnumerable<FilmSearch> GetTopFilmsFromPageRangeAsync(Range pageRange, CancellationToken ct, Tops topType = Tops.TOP_250_BEST_FILMS)
        {
            return GetTopFilmsFromPageRangeAsync(ct, pageRange.Start.Value, pageRange.End.Value, topType);
        }
        
        public IAsyncEnumerable<FilmSearch> GetTopFilmsFromPageRangeAsync(CancellationToken ct, int fromPage = -1, int toPage = -1, Tops topType = Tops.TOP_250_BEST_FILMS)
        {  
        ...
        public async Task<FilmsResponseWithPagesCount<FilmSearch>> GetFilmsByKeywordAsync(string keyword, CancellationToken ct, int page = 1)
        {
        ...
        public async Task<GenresAndCountriesResponse> GetGenresAndCountriesAsync(CancellationToken ct)
        {
            string path = $"{constants.FiltersUrlV22}";
            return await GetResponseDataAsync<GenresAndCountriesResponse>(path, ct);
        }

        public async Task<FilmsResponseWithPagesCount<Film>> GetFilmsByFiltersAsync(CancellationToken ct, int countryId = (int)Filter.ALL,
        ...
        public async Task<FilmsResponse<RelatedFilm>> GetRelatedFilmsAsync(int id, CancellationToken ct)
        {
        ...
        public async Task<FilmsResponseWithPagesCount<FilmSearch>> GetTopFilmsAsync(CancellationToken ct,
        ...
        public async Task<FilmsResponse<FactsAndMistakes>> GetFilmFactsAndMistakesAsync(int id, CancellationToken ct)
        {
        ...
        public async Task<FilmsResponse<FilmDistributionsResponseItems>> GetFilmDistributionsAsync(int id, CancellationToken ct)
        {
        ...
        public async Task<FilmSearch[]> GetSequelsAndPrequelsByIdAsync(int id, CancellationToken ct)
        {
        ...
        public async Task<ViewerReviewsResponse> GetViewerReviewsByIdAsync(int id, CancellationToken ct, int page = 1,
        ...
        public async Task<FilmsResponse<MonetizationInfo>> GetBoxOfficeByIdAsync(int id, CancellationToken ct)
        {
        ...
        public async Task<FilmsResponse<Season>> GetSeasonsDataByIdAsync(int id, CancellationToken ct)
        {
        ...
        public async Task<FilmsResponseWithPagesCount<ImageResponse>> GetImagesByIdAsync(int id, CancellationToken ct,
        ...
        public async Task<StaffResponse[]> GetStaffByFilmIdAsync(int filmId, CancellationToken ct)
        {
            var queryParams = new Dictionary<string, string>
            {
        ...
        public async Task<FilmsResponse<FilmPremiere>> GetPremieresListAsync(int year, Months month, CancellationToken ct)
        {
            var queryParams = new Dictionary<string, string>
            {
                ["year"] = year.ToString(),
        ...
        public async Task<FilmsResponse<Video>> GetTrailersAndTeasersByIdAsync(int id, CancellationToken ct)
        {
        ...
        public async Task<FilmsResponse<Nomination>> GetAwardsByIdAsync(int id, CancellationToken ct)
        {
        ...
        public async Task<FilmsResponse<FilmPersonInfo>> GetPersonByNameAsync(string name, CancellationToken ct, int page = 1)
        {
            var queryParams = new Dictionary<string, string>
            {
                ["name"] = name,
        ...
        public async Task<PersonResponse> GetStaffByPersonIdAsync(int personId, CancellationToken ct)
        {
